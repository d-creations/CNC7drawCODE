...
export class HorizontalMeasurementTool extends BaseTool {
    ...
    finalizeMeasurement(p1, p2) {
        if (!this.currentMeasurement) {
            this.currentMeasurement = new HorizontalMeasurementShape(this.drawBoard, p1, p2);
        }
    ...
    onMouseMove(x, y) {
        if (this.step === 1) {
            ...
            if (!this.currentMeasurement) {
                this.currentMeasurement = new HorizontalMeasurementShape(this.drawBoard, this.p1, worldPos);
